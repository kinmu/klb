 ...
 * <PRE>
 * @Project Name	: KONGJU
 * @File Name		: Seedx.java
 * @Comment			: 보안모듈?�본 SeedCipher.java�?�?��??
 * @Author			: eunjung
 * @Creation Date	: 2012. 1. 12.?�후 6:02:54
...
/***************************** SEED round function ****************************/
	...
	/**
	 * METHOD Comment : 
	 * @param L0 [in, out] left-side variable at each round
	 * @param L1 [in, out] left-side variable at each round
	 * @param R0 [in] right-side variable at each round
	 * @param R1 [in] right-side variable at each round
	 * @param K [in] round keys at each round
	 */
...
/************************** SEED encrtyption function *************************/
	...
	/**
	 * METHOD Comment : 
	 * @param pbData [in] 128비트???�호?�될 ?�이?��? ?�력
	 * @param pdwRoundKey [in] SEED??�??�운?�에 ?�용?�는 ?�운???��? ?�력. ?�운???�는 SeedRoundKey?�수�??�해 ?�용?�의 비�??�로�?�� ?�성
	 * @param outData [out] 128비트???�호?�된 ?�이?��? 출력
	 */
...
/************************** SEED decrtyption function *************************/
	...
	/**
	 * METHOD Comment : Same as encrypt, except that round keys are applied in reverse order
	 * @param pbData [in] 128비트???�호?�된 ?�이?��? ?�력
	 * @param pdwRoundKey [in] SEED??�??�운?�에 ?�용?�는 ?�운???��? ?�력. ?�운???�는 SeedRoundKey ?�수�??�해 ?�용?�의 비�??�로�?�� ?�성
	 * @param outData [out] 128비트??복호?�된 ?�이?��? 출력
	 */
...
/******************************** Key Schedule ********************************/
	...
	/**
	 * METHOD Comment : 
	 * @param pdwRoundKey [out] SEED??�??�운?�에 ?�용?�는 ?�운????
	 * @param pbUserKey [in]	?�운???��? ?�성?�기 ?�해 ?�용?�는 ?�용?�의 비�???
	 */
