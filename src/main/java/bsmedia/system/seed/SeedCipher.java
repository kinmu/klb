 ...
 * <PRE>
 * @Project Name	: KONGJU
 * @File Name		: SeedCipher.java(Seedx.java �?���?
 * @Comment			: Seed 블럭?�호 API <br /> 
 * ?�국?�보보호진흥?�에???�공?�는 Java API�?조금 ?�정 ?? <br /> 
 * Padding??ANSI X.923???�용 ??
 * @Author			: eunjung
 * @Creation Date	: 2012. 1. 13.?�후 4:04:04
...
public class SeedCipher {
	...
	/**
	 * ?�국?�보보호진흥???�스???�는 추�? ???�수�??�력 받�? 바이???�이?��? ?�호???�여 리턴?�다.
	 * 
	 * @param inData
	 *            String ?�문
	 * @param szKey
	...
	/**
	 * ?�국?�보보호진흥???�스???�는 추�? ???�수�??�력 받�? 문자?�을 ?�호???�여 리턴?�다.
	 * 
	 * @param inData
	 *            String ?�문
	 * @param szKey
	...
	/**
	 * ?�국?�보보호진흥???�스???�는 추�? ???�수�??�력 받�? 문자?�을 ?�정 Charset?�로 �?��?�여 ?�호???�여 리턴?�다.
	 * 
	 * @param inData
	 *            String ?�문
	 * @param szKey
	 *            byte[] key
	 * @param charset
	 *            String String??byte ?�이?�로 �?��?�때 ?�용??charset
	 * @return byte[] ?�호?????�이??
	 */
	...
	/**
	 * ?�국?�보보호진흥???�스???�는 추�? ???�수�??�호????바이???�이?��? 받아??복호?�한??
	 * 
	 * @param encryptBytes
	 *            byte[] ?�호????바이???�이??
	 * @param szKey
	...
	/**
	 * ?�국?�보보호진흥???�스???�는 추�? ???�수�??�호????바이???�이?��? 받아??복호?�하??문자?�로 반환?�다.
	 * 
	 * @param encryptBytes
	 *            byte[] ?�호????바이???�이??
	 * @param szKey
	...
	/**
	 * ?�국?�보보호진흥???�스???�는 추�? ???�수�??�호????바이???�이?��? 받아??복호?�하??�?��??charset?�로 문자?�로
	 * 반환?�다.
	 * 
	 * @param encryptBytes
	 *            byte[] ?�호????바이???�이??
	 ...
	 *            byte[] key
	 * @param String
	 *            charset 복호????바이???�이?��? 문자?�로 �?��?????�용??Charset
	 * @return byte[] 복호????바이???�이??
	 */
	public String decryptAsString(byte[] encryptBytes, byte[] szKey,
